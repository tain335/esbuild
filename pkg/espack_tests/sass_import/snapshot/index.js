...
webpackJsonp.push([["0"], {"<style_runtime>": (function(module, exports, require) {
  var isOldIE = function() {
    var memo;
    return function() {
      return typeof memo > "u" && (memo = Boolean(window && document && document.all && !window.atob)), memo;
    };
  }(), getTarget = function() {
    var memo = {};
    return function(target) {
      if (typeof memo[target] > "u") {
  ...
  function modulesToDom(list, options) {
    for (var idCountMap = {}, identifiers = [], i = 0; i < list.length; i++) {
      ...
      index !== -1 ? (stylesInDom[index].references++, stylesInDom[index].updater(obj)) : stylesInDom.push({
        identifier,
  ...
  function addStyle(obj, options) {
    ...
    if (options.singleton) {
      ...
      style = singleton || (singleton = insertStyleElement(options)), update = applyToSingletonTag.bind(null, style, styleIndex, false), remove = applyToSingletonTag.bind(null, style, styleIndex, true);
    } else
      style = insertStyleElement(options), update = applyToTag.bind(null, style, options), remove = function() {
  ...
  exports.__esModule = true, exports.default = function(list, options) {
    options = options || {}, !options.singleton && typeof options.singleton != "boolean" && (options.singleton = isOldIE()), list = list || [];
    var lastIdentifiers = modulesToDom(list, options);
    return function(newList) {
      if (newList = newList || [], Object.prototype.toString.call(newList) === "[object Array]") {
...
webpackJsonp.push([["0"], {"/Users/yanbo.wu/Documents/projects/tmp/esbuild/pkg/espack_tests/sass_import/src/app.scss": (function(module, exports, require) {
  var api = (0, require.n)(require("<style_runtime>"));
  ;
...
webpackJsonp.push([["0"], {"/Users/yanbo.wu/Documents/projects/tmp/esbuild/pkg/espack_tests/sass_import/src/index.tsx": (function(module, exports, require) {
  require("/Users/yanbo.wu/Documents/projects/tmp/esbuild/pkg/espack_tests/sass_import/src/app.scss");
  ;
...
webpackJsonp.push([["0"], {"<initial_module_4>": (function(module, exports, require) {
  ...
  require("/Users/yanbo.wu/Documents/projects/tmp/esbuild/pkg/espack_tests/sass_import/src/index.tsx");
}) },[["<initial_module_4>"]]]);
